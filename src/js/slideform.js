...
( function ($) {
    ...
    $.fn.slideform = function( userOptions, args ) {
        ...
        // Slides List
        var $slides = $form.find("div[class*='slideform-slide']");
        ...
        $form.on('click', '.slideform-btn', function (event) {
            ...
            if ( btn.hasClass('slideform-btn-goto') ) {

                $current = parseInt(btn.attr('value'))-1;
                if($current<0 || $current>$slides.length) {
                    alert("Slider number invalid");
                    return;
                }
                $form.goTo($current);
            }
        ...
        function init() {
            ...
            $track = $('<div />', { class: 'slideform-track'})
                .insertBefore( $form.find("div[class*='slideform-slide']").eq(0) );

            // Adding the wrapper.
            $wrapper = $('<div />', { class: 'slideform-wrapper' })
                .appendTo( $track )
                .append($form.find("div[class*='slideform-slide']"));
             ...
             */
            $form.find("div[class*='slideform-slide']").each( function (k, v) {
        ...
        function setSlidesHeight() {
            $form.find("div[class*='slideform-slide']").css('height', $track.outerHeight());
        }
